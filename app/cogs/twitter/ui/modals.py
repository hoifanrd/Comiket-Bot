...
class CircleBoothModal(Modal):
    """添加新項目的模態窗口（支持多項目）"""
    def __init__(self, circle_data: dict, *args, **kwargs):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if not re.match(r'^[1-9][0-9]?(ab?|b)$', self.booth):
...
class CircleInfoModal(Modal):
    ...
    def __init__(self, circle_data: dict, *args, **kwargs):
        ...
        self.author_input = TextInput(
            ...
            placeholder="請輸入畫師名稱",
            style=discord.TextStyle.short,
            default=circle_data.get('author_name', ''),
            min_length=1,
            max_length=50
        )
        ...
        self.circle_input = TextInput(
            ...
            placeholder="請輸入社團名稱",
            style=discord.TextStyle.short,
            default=circle_data.get('circle_name', ''),
            min_length=1,
            max_length=50
        )
