...
class ItemButton(Button):
    ...
    async def _show_special_confirmation(self, interaction: discord.Interaction):
        ...
        async def need_callback(interaction: discord.Interaction):
            ...
            view.stop()
            await self._show_normal_confirmation(interaction, extra)
    ...
    async def _show_normal_confirmation(self, interaction: discord.Interaction, extra: dict = None):
        ...
        async def confirm_callback(interaction: discord.Interaction):
            ...
            database.update_username(user.id, display_name)
            database.create_vote(user.id, self.poll_id, self.item, extra)
